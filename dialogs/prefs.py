...
class main(Gtk.Dialog):
    def __init__(self, parent):
        ...
        #iface_content.pack_start(layout_frame, False, True, 0) #TODO show these controls once tabs and multi-window mode are implemented
        ...
        # TODO add this back in when tabbing or multiple windows are supported
